    ...
    <v-layout align-start>
        <v-flex>
            <v-toolbar flat color="white">
                <v-toolbar-title>MedicalEquipment</v-toolbar-title>
                    <v-divider
                    class="mx-2"
                    inset
                    vertical
                    ...
                    <v-dialog v-model="dialog" max-width="500px">
                        ...
                        <v-card>
                            ...
                            <v-container grid-list-md>
                                ...
                                <v-flex xs12 sm6 md6>
                                    <v-text-field v-model="brand" label="Brand">
                                    </v-text-field>
                                </v-flex>
                                <v-flex xs12 sm6 md6>
           ...
           <v-data-table :headers="headers" :items="medicalequipment" :search="search" class="elevation-1">
...
<script>
    ...
    export default {
        ...
        methods:{
            listar(){
                let me=this;
                axios.get("api/medicalequipmet").then(function(response){
            ...
            editItem (item) {
                this.id=item.idmedical-equipment;
